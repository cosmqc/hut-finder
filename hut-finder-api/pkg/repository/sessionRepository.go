...
// GetSession Gets a session struct by a token.
...
// CreateSession Creates a new session, with the user's id and generated token.
...
// DeleteSessionByUserIdAndToken Deletes session.
